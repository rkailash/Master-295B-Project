      ...
      <div className="property-details">
        ...
        <div className="total-pricing">
          <div className="price-calculator">
            ...
            <select
              onChange={e =>
                this.setState({ options: parseInt(e.target.value) })
              }
              placeholder="community hours"
              name="type"
            >
              <option value=""></option>
          ...
          <div className="total">
            <p>Total:</p>
            <span>{`$${this.props.item.price -
              this.state.options * 100}`}</span>
          </div>
          <button
        ...
        <Modal isOpen={this.state.modal}>
          <ModalBody>
            Congratulations! The owner has been notified. You'll be contacted
            shortly.
          </ModalBody>
          <ModalFooter>
            <Button color="danger" onClick={this.handleBook}>
              Dismiss
            </Button>
          </ModalFooter>
        </Modal>
