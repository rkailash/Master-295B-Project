...
const LoginDropdown = () => (
  <Fragment>
    ...
    <DropdownMenu>
      <DropdownItem>
        <Link to="/TravellerLogin">User login</Link>
      </DropdownItem>
      {/* <DropdownItem>
            ...
            >
              <g transform="translate(-1)">
                <g>
                  <g>
                    <path
                      d="M128.686,37.216c-4.761-4.067-11.789-4.012-16.486,0.128L77.853,68.081v-4.028c0-4.713-3.82-8.533-8.533-8.533     s-8.533,3.82-8.533,8.533v19.311L46.561,96.096c-3.459,3.155-3.73,8.508-0.607,11.997s8.473,3.809,11.99,0.718l62.575-56.013     l62.575,56.013c2.266,2.067,5.468,2.759,8.385,1.812c2.918-0.947,5.102-3.387,5.722-6.392c0.62-3.004-0.42-6.11-2.724-8.135     L128.686,37.216z"
                      fill="#5e6d77"
                    />
                    <path
                      d="M171.72,119.52c-4.713,0-8.533,3.82-8.533,8.533v59.733H77.853v-59.733c0-4.713-3.82-8.533-8.533-8.533     s-8.533,3.82-8.533,8.533v65.152c0.084,6.515,5.432,11.729,11.947,11.648h95.573c6.519,0.066,11.862-5.155,11.947-11.674v-65.126     C180.253,123.34,176.432,119.52,171.72,119.52z"
                      fill="#5e6d77"
                    />
                    <path
                      d="M120.52,221.92c-32.99,0-59.733,26.744-59.733,59.733s26.744,59.733,59.733,59.733s59.733-26.744,59.733-59.733     C180.215,248.679,153.494,221.957,120.52,221.92z M77.853,281.653c0.026-20.268,14.281-37.731,34.133-41.813v36.975     L80.413,295.75C78.76,291.232,77.894,286.464,77.853,281.653z M89.207,310.382l29.99-17.994l24.815,24.815     C126.579,328.833,103.257,325.93,89.207,310.382z M156.078,305.137l-27.025-27.017V239.84     c13.892,2.815,25.474,12.357,30.895,25.454C165.368,278.391,163.918,293.327,156.078,305.137z"
                      fill="#5e6d77"
                    />
                    <path
      ...
      <div className={`header ${design === "gradient" ? "gradient" : ""}`}>
        ...
        <div className="right-container">
          ...
          <img
            ...
            src={
              design === "gradient"
                ? "https://www.google.com/url?sa=i&source=images&cd=&ved=2ahUKEwj-0KCgv7zkAhWQGDQIHbmMAvkQjRx6BAgBEAQ&url=http%3A%2F%2Fwww.homeforeveryone.us%2Flistings%2F3504-briercliff-dr-denton-tx-76210%2F&psig=AOvVaw0BYAbf5SQTsOy-TtFs0l9Z&ust=1567869487461261"
